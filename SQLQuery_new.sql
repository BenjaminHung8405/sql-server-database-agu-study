...
on(
name = 'QLSVien_dat',
filename = 'D:\DoAn_Fix\QlSVdata.mdf',
size = 8,
maxsize = 64,
filegrowth = 2
)
...
log on( 
name = 'QLSVien_log',
filename = 'D:\DoAn_Fix\QlSVlog.ldf',
size = 8,
maxsize = 64,
filegrowth = 2
)
...
ALTER TABLE DAY
ADD CONSTRAINT PK_DAY PRIMARY KEY (MaGV,MaMon);
...
ALTER TABLE KETQUA
ADD CONSTRAINT pk_KETQUA PRIMARY KEY (MaSV,MaMon);
